...
What is the worst month to fly in terms of weather delays? Which month is the best weather delay month to fly? The answers to these questions are explored by comparing the average number of minutes delayed due to weather as a percentage of all flights, grouped by Month for US Flights, 2003-2016 and in descending order by the delay ratio. 
...
The results show that the worst months to fly in terms of the total number of weather delays are December followed by January, and the best months to fly are April followed by May. However, when the ratio of delayed flights to total flights is calculated for each month, the results change significantly. The worst months to fly in terms of the ratio are the winter months in general, with December through March showing a close grouping from 37.9% for December up to 39.7% for January. The best months to fly are the summer months, also showing a very tight cluster, with July being the best at 28% and May the worst at 29.3%.

GQ3 TABLE 1 - Showing the ratio of delayed flights due to weather to the total number of flights at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the delay ratio.
...
GQ3 CHART 1 - Showing the ratio of delayed flights due to weather to the total number of flights at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the delay ratio.
...
GQ3 TABLE 2 - Showing the total number of delayed flights due to weather at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the number of delayed flights.
...
GQ3 CHART 2 - Showing the total number of delayed flights due to weather at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the number of delayed flights.
...
GQ3 TABLE 3 - Showing the ratio of the total number of delayed flight minutes due to weather to the total flight number of flights at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the ratio.
...
GQ3 CHART 3 - Showing the ratio of the total number of delayed flight minutes due to weather to the total flight number of flights at seven selected hub airports in the U.S., grouped by Month for US Flights, 2003-2016 and in descending order by the ratio.
...
Which of the seven selected hub airports have the most total flight delays due to weather? This question will be answered by looking at the total number of delayed flights due to weather at each of the seven selected hub airports. The data will be grouped by airport and then sorted in descending order by the total number of delayed flights due to weather. The data will be displayed in a table and a chart.
...
When the ratio of total delayed flights to total flights is calculated for each airport, San Francisco rises to the position of the worst ration of delayed flights, and San Diego still is the the top position with the lowest ratio.

GQ4 TABLE 1 - Showing the total number of delayed flights due to weather at seven selected hub airports in the U.S., grouped by Airport for US Flights, 2003-2016 and in ascending order by the number of delayed flights.
...
GQ4 CHART 1 - Showing the total number of delayed flights due to weather at seven selected hub airports in the U.S., grouped by Airport for US Flights, 2003-2016 and in ascending order by the number of delayed flights.
...
GQ4 TABLE 2 - Showing the ratio of the total number of weather delayed flights to the total number opf flights at seven selected hub airports in the U.S., grouped by Airport for US Flights, 2003-2016 and in ascending order by the ratio.
...
GQ4 CHART 2 - Showing the ratio of the total number of weather delayed flights to the total number opf flights at seven selected hub airports in the U.S., grouped by Airport for US Flights, 2003-2016 and in ascending order by the ratio.
...
GQ5 TABLE 1 - Table showin a single record with NaN values in place of missing data.
