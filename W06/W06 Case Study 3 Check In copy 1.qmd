...
dat = pd.read_sql_query( 
    "SELECT t.teamid, t.yearid, sal.yearid, t.r, t.w, t.attendance, CAST(SUM(sal.salary) as int) FROM Teams AS t JOIN Salaries as sal ON t.teamid=sal.teamid WHERE (t.teamid='NYA' OR t.teamid='OAK') AND (t.yearid>1995 AND t.yearid<2010) GROUP BY t.teamid, t.yearid", con)
