...
q = "SELECT name, year, SUM(total) as new_total_for_1964 FROM dat WHERE NAME = 'Scott' and YEAR = 1964"
dat_1964 = sqldf(q, globals())
dat_1964

mydat = dat_1964.head(1000)\
    .sum()\
    .reset_index()\
    .tail(10)
display(mydat)
...
alt.Chart(dat_1964)\
    .encode(x="name", y="new_total_for_1964")\
    .mark_bar(width = 50)\
    .properties(
        width=800,
        height=300
...
dat1964 = sqldf(q, globals())
dat1964
# mydat = dat1964.head(1000)\
#     .sum()\
#     .reset_index()\
#     .tail(51)
# display(mydat)
